defmodule ChatouriusWeb.Coherence.ViewHelpers do
  @moduledoc """
  ...
  For example, to generate links in your layout template use:
      ChatouriusWeb.Coherence.ViewHelps.coherence_links/3
  ...
  import ChatouriusWeb.Gettext

  @type conn :: Plug.Conn.t()
  @type schema :: Ecto.Schema.t()

  @seperator {:safe, "&nbsp; | &nbsp;"}
  @helpers ChatouriusWeb.Router.Helpers
  ...
  * :register - customize the register link text (#{@register_link_text})
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ChatouriusWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ChatouriusWeb.Gettext, "errors", msg, opts)
    end
  end
